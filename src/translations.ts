export const TRANSLATIONS = {
    ...
    autoSolveFirstTryMessage: 'When you press auto solve button, the game will start moving discs by itself. If you want to stop the process, press on the button again. Auto solve is working only from complete start, it can\'t continue. Also, if you press auto solve, your score will not count. So, looks like it\'s my turn now :)',
